...
<body>
    ...
    <section class="bg-[#FFFAE6]">
        <div class="grid max-w-screen-xl px-4 pt-28 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28 lg:relative">
            <div class="hidden lg:flex space-x-4 lg:justify-end lg:absolute lg:right-0 lg:top-4" id="navbar-menu">
